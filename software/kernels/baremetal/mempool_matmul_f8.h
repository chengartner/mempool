...
void matmul_4x2_parallel_inner_f8vec(const __fp8 *__restrict__ A,
  ...
  v4b aElem01 = *(v4b *)&(A[4]);
  v4b packed;
  unsigned TempShuffle1 = 0b10001101;

  asm volatile(
    "pv.pack %[packed], %[aElem01], %[aElem00];"
    "pv.shuffle2.b %[packed], %[packed], %[TempShuffle1];"
    : [aElem00] "+&r"(aElem00), [aElem01] "+&r"(aElem01)
    : [packed] "r"(packed), [TempShuffle1] "r"(TempShuffle1)
    );
}
*/
  ...
  for (k = core_id * 4; k < P; k += numThreads * 4) {
    for (i = 0; i < M; i += 2) {
      ...
      for (j = 0; j < N; j += 4) {
        ...
        v4b bVecTemp2 = *(v4b *)&(B[(j + 2) * P + k]);  // bVecTemp2 = [b20 b21 b22 b23]
        v4b bVecTemp3 = *(v4b *)&(B[(j + 3) * P + k]);  // bVecTemp3 = [b30 b31 b32 b33]
        v4b bVec0, bVec1, bVec2, bVec3, bVecLow0, bVecLow1, bVecLow2, bVecLow3;
        unsigned TempShuffle1 = 0b0110010001110101; // [a b c d] => [b d a c]
        unsigned TempShuffle2 = 0b0101010001110110; // [a b c d] => [c d a b]
        asm volatile(
            "pv.pack.h %[bVec2], %[bVecTemp0], %[bVecTemp1];"    // bVec2 = [b02 b03 b12 b13]
            "pv.shuffle2.b %[bVec2], %[bVec2], %[TempShuffle1];" // bVec2 = [b03 b13 b02 b12]
            "pv.extract.h %[bVec3], %[bVec2], 1;" // bVec3 = [0 0 b03 b13]
            "pv.shuffle2.b %[bVec3], %[bVec3], %[TempShuffle2]" // bVec3 = [b03 b13 0 0]
            "pv.extract.h %[bVec2], %[bVec2], 0;" // bVec2 = [0 0 b02 b12]
            "pv.shuffle2.b %[bVec2], %[bVec2], %[TempShuffle2]" // bVec2 = [b02 b12 0 0]            
            ...
            "pv.extract.h %[bVec1], %[bVec0], 1;" // bVec1 = [0 0 b01 b11]
            "pv.shuffle2.b %[bVec1], %[bVec1], %[TempShuffle2]" // bVec3 = [b01 b11 0 0]
            "pv.extract.h %[bVec0], %[bVec0], 0;" // bVec0 = [0 0 b00 b10]
            "pv.shuffle2.b %[bVec0], %[bVec0], %[TempShuffle2]" // bVec0 = [b00 b10 0 0]

            "pv.pack.h %[bVecLow2], %[bVecTemp2], %[bVecTemp3];"       // bVecLow2 = [b22 b23 b32 b33]
            "pv.shuffle2.b %[bVecLow2], %[bVecLow2], %[TempShuffle1];" // bVecLow2 = [b23 b33 b22 b32]
            "pv.extract.h %[bVecLow3], %[bVecLow2], 1;" // bVecLow3 = [b23 b33]
            "pv.extract.h %[bVecLow2], %[bVecLow2], 0;" // bVecLow2 = [b22 b32]
            "pv.shuffle2.b %[bVecTemp2], %[bVecTemp2], %[TempShuffle2];" // bVecTemp0 = [b22 b23 b20 b21]
            "pv.shuffle2.b %[bVecTemp3], %[bVecTemp3], %[TempShuffle2];" // bVecTemp1 = [b32 b33 b30 b31]
            "pv.pack.h %[bVecLow0], %[bVecTemp2], %[bVecTemp3];"       // bVecLow0 = [b20 b21 b30 b31]
            "pv.shuffle2.b %[bVecLow0], %[bVecLow0], %[TempShuffle1];" // bVecLow0 = [b21 b31 b20 b30]
            "pv.extract.h %[bVecLow1], %[bVecLow0], 1;" // bVecLow1 = [b21 b31]
            "pv.extract.h %[bVecLow0], %[bVecLow0], 0;" // bVecLow0 = [b20 b30]

            "vfdotpexa.s.b %[sum00], %[aVec0], %[bVec0];"      // aRes0 = a00*b00 + a01*b10
            "vfdotpexb.s.b %[sumTemp], %[aVec0], %[bVecLow0];" // aRes1 = a02*b20 + a03*b30
            "vfadd.h %[sum00], %[sum00], %[sumTemp];"
            "vfdotpexa.s.b %[sum01], %[aVec0], %[bVec1];"
            "vfdotpexb.s.b %[sumTemp], %[aVec0], %[bVecLow1];"
            "vfadd.h %[sum01], %[sum01], %[sumTemp];"
            "vfdotpexa.s.b %[sum02], %[aVec0], %[bVec2];"
            "vfdotpexb.s.b %[sumTemp], %[aVec0], %[bVecLow2];"
            "vfadd.h %[sum02], %[sum02], %[sumTemp];"            
            "vfdotpexa.s.b %[sum03], %[aVec0], %[bVec3];"
            "vfdotpexb.s.b %[sumTemp], %[aVec0], %[bVecLow3];"
            "vfadd.h %[sum03], %[sum03], %[sumTemp];"            
            "vfdotpexa.s.b %[sum10], %[aVec1], %[bVec0];"
            "vfdotpexb.s.b %[sumTemp], %[aVec1], %[bVecLow0];"
            "vfadd.h %[sum10], %[sum03], %[sumTemp];"
            "vfdotpexa.s.b %[sum11], %[aVec1], %[bVec1];"
            "vfdotpexb.s.b %[sumTemp], %[aVec1], %[bVecLow1];"
            "vfadd.h %[sum11], %[sum03], %[sumTemp];"
            "vfdotpexa.s.b %[sum12], %[aVec1], %[bVec2];"
            "vfdotpexb.s.b %[sumTemp], %[aVec1], %[bVecLow2];"
            "vfadd.h %[sum12], %[sum03], %[sumTemp];"
            "vfdotpexa.s.b %[sum13], %[aVec1], %[bVec3];"
            "vfdotpexb.s.b %[sumTemp], %[aVec1], %[bVecLow3];"
            "vfadd.h %[sum13], %[sum03], %[sumTemp];"
            : [sum00] "=&r"(sum00), [sum01] "=&r"(sum01), [sum02] "=&r"(sum02), [sum03] "=&r"(sum03),
              ...
              [bVecTemp3] "+&r"(bVecTemp3), [sumTemp] "+&r"(sumTemp)
