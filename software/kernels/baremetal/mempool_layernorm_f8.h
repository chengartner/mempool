  ...
  for (i = core_id * 2; i < M; i += numThreads * 2) {
    ...
    for (j = 0; j < N; j += 8) {
      ...
      asm volatile(
        ...
        "vfmul.b %[aVec00], %[aVec00], %[aVec00];"  // aVec00 stores square of loaded aVec00
        "vfmul.b %[aVec10], %[aVec10], %[aVec10];"  // aVec10 stores square of loaded aVec10
        ...
        : [vSum0] "+&r"(vSumMean0), [vSum1] "+&r"(vSumMean1), [vSumSq0] "+&r"(vSumSq0),
          [vSumSq1] "+&r"(vSumSq1), [aVecSq01] "+&r"(aVecSq01), [aVecSq11] "+&r"(aVecSq11)
        : [aVec00] "r"(aVec00), [aVec01] "r"(aVec01), [aVec10] "r"(aVec10),
          [aVec11] "r"(aVec11));
    }

    //dump_try(*(uint32_t*)&vSumMean0);
    ...
    asm volatile(
      ...
      "vfadd.b %[ShuffleMask0], %[x0], %[x1];" // Use ShuffleMask as temp storage
      ...
      : [vSum0] "+&r"(vSumMean0), [vSum1] "+&r"(vSumMean1), [vSumSq0] "+&r"(vSumSq0),
        [vSumSq1] "+&r"(vSumSq1), [x0] "+&r"(x0), [x1] "+&r"(x1),
        [x2] "+&r"(x2), [x3] "+&r"(x3), [y0] "+&r"(y0), 
    ...
    for (j = 0; j < N; j += 8) {
      ...
      "vfdiv.b %[aVec11], %[aVec11], %[vStd1];"
        : [aVec00] "+&r"(x0), [aVec01] "+&r"(x1),
          [aVec10] "+&r"(x2), [aVec11] "+&r"(x3)
        : [vMean0] "r"(vSumMean0), [vMean1] "r"(vSumMean0), [vStd0] "r"(vSumSq0),
          [vStd1] "r"(vSumSq1));
...
void layernorm_parallel_2x8_f8vec(const __fp8 *__restrict__ A,
  ...
  for (i = core_id * 2; i < M; i += numThreads * 2) {
    ...
    asm volatile(
      ...
      "vfadd.b %[vSum0], %[x0], %[x1];"
      "vfadd.b %[vSum1], %[x2], %[x3];"
      "vfadd.b %[vSumSq0], %[y0], %[y1];"
      "vfadd.b %[vSumSq1], %[y2], %[y3];"
      ...
      "pv.shuffle2.b %[y2], %[vSumSq1], %[ShuffleMask2];"
      "pv.shuffle2.b %[y3], %[vSumSq1], %[ShuffleMask3];"
      "vfadd.b %[vSum0], %[vSum0], %[x0];"
      "vfadd.b %[vSum1], %[vSum1], %[x1];"
      "vfadd.b %[vSumSq0], %[vSumSq0], %[y0];"
      "vfadd.b %[vSumSq1], %[vSumSq1], %[y1];"
      "vfadd.b %[vSum0], %[vSum0], %[x2];"
      "vfadd.b %[vSum1], %[vSum1], %[x3];"
      "vfadd.b %[vSumSq0], %[vSumSq0], %[y2];"
      "vfadd.b %[vSumSq1], %[vSumSq1], %[y3];"
